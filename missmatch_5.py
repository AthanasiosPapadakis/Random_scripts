...
df1 = pd.DataFrame(differentvisits, index=['MN1', 'MN2', 'MN3', 'MN4', 'MN5'], columns=["Visits"])
df1.to_csv('differentvisits5.csv')
df2 = pd.DataFrame(perfectchanges, columns=["MobileNode", "Timestamp", "StaticNode"])
df2.to_csv('perfectchanges5.csv')
df3 = pd.DataFrame(timestayed, index=['MN1', 'MN2', 'MN3', 'MN4', 'MN5'])
df3.to_csv('timestayed5.csv')
df4 = pd.DataFrame(sequence, index=['MN1', 'MN2', 'MN3', 'MN4', 'MN5'])
df4.to_csv('sequence5.csv')
df5 = pd.DataFrame(sumtimestayed, columns=["SN1", "SN2", "SN3", "SN4", "SN5", "SN6", "SN7", "SN8", "SN9", "SN10", "SN11", "SN12", "SN13", "SN14", "SN15", "SN16", "SN17", "SN18", "SN19", "SN20", "SN21", "SN22", "SN23","SN24"], index=['MN1', 'MN2', 'MN3', 'MN4', 'MN5'])
df5.to_csv('sumtimestayed5.csv')
df6 = pd.DataFrame(sumtimesvisited, columns=["SN1", "SN2", "SN3", "SN4", "SN5", "SN6", "SN7", "SN8", "SN9", "SN10", "SN11", "SN12", "SN13", "SN14", "SN15", "SN16", "SN17", "SN18", "SN19", "SN20", "SN21", "SN22", "SN23","SN24"], index=['MN1', 'MN2', 'MN3', 'MN4', 'MN5'])
df6.to_csv('sumtimesvisited5.csv')
